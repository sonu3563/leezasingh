...
<div className="sticky top-0 z-10 bg-white shadow-md">
  <div className="container mx-auto p-6 flex justify-between items-center space-x-8">
  ...
  <div className="bg-white p-6 rounded-xl shadow-lg mb-8 flex items-center justify-between space-x-4">
