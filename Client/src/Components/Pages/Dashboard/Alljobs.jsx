...
import JobCard from '../../ui/DasboardComponent/Jobcard';
// import job
...
const Alljobs = () => {
  ...
  const [role, seRole] = useState(false);
...
// const [applyModalOpen, setApplyModalOpen] = useState(false);
  ...
  <div className="sticky top-0 bg-white  shadow-md">
                   <h2 className="text-3xl font-bold text-center py-6">All Jobs</h2>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4 text-sm text-gray-700">
            <div>
             ...
             <a className='text-blue-600 underline' href={`mailto:${selectedJob.company?.supportEmail}`}>
                  {selectedJob.company?.supportEmail}
              </a>
              </p>
              <p><strong>Phone:</strong> 
              <a className='text-blue-600 underline' href={`tel:${selectedJob.company?.supportPhoneNumber}`}>
                  {selectedJob.company?.supportPhoneNumber}
              </a>
              </p>
            </div>
            <div>
