...
const SpecificRole = () => {
  const { specificjobs, loading, error,applyForJob ,alert,setApplyModalOpen,applyModalOpen ,setCoverLetter ,coverLetter} = useJob();
...
// const [applyModalOpen, setApplyModalOpen] = useState(false);
  ...
  const filteredJobs = specificjobs?.filter((job) => {
  ...
  <div className="sticky top-0 bg-white  shadow-md">
                    <h2 className="text-3xl font-bold text-center py-6">Category Based Jobs</h2>
